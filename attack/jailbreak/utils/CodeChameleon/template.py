...
def get_prompts_text(encrypted_query, encrypt_rule):
    ...
    if encrypt_rule!='none':
        complete_prompt = text_template_with_encrypt.format(decryption, encrypted_query)
    else:
        complete_prompt = text_template_without_encrypt.format(encrypted_query)
...
def get_prompts_code(encrypted_query, encrypt_rule):
    ...
    if encrypt_rule!='none':
        complete_prompt = code_template_with_encrypt.format(decryption,encrypted_query)
    else:
        complete_prompt = code_template_without_encrypt.format(encrypted_query)

    return complete_prompt


def get_prompts(goal, args):
    encrypted_query = get_encrypted_query(goal, args.encrypt_rule)
    if args.prompt_style=='text':
        complete_prompt = get_prompts_text(encrypted_query, args.encrypt_rule)
    if args.prompt_style=='code':
        complete_prompt = get_prompts_code(encrypted_query, args.encrypt_rule)
