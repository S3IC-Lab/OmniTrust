...
@DatasetRegistry.register("agnews")
class agnewsDataset(BaseDataset):
    def __init__(self, data_dir: str, datatype, **kwargs):
        super(agnewsDataset, self).__init__(data_dir, **kwargs)
        self.prompts = []
        self.labels = []
    ...
    def load_data(self):
        ...
        print(f"Loaded {self.total_entries} entries from agnews dataset.")
    ...
    def process_data(self, ):
        ...
        self.data = processed
        print(f"Processed {len(self.data)} entries from agnews dataset.")
