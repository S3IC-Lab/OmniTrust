...
class xsumDataset(BaseDataset):
    def __init__(self, data_dir: str, datatype, **kwargs):
        super(xsumDataset, self).__init__(data_dir, **kwargs)
        self.prompts = []
        self.labels = []
        self.total_entries = 0
        self.type = datatype
        self.data_dir = f"{self.data_dir}/{self.type}"
    def load_data(self):
        """
        ...
        print(f"Loaded {self.total_entries} entries from xsum dataset.")
    ...
    def process_data(self, ):
        ...
        self.data = processed
        print(f"Processed {len(self.data)} entries from xsum dataset.")
