...
The **Safety Module** evaluates jailbreak robustness, harmfulness resistance, and the model’s ability to comply with safety constraints under adversarial input conditions.
