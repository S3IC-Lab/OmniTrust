...
BASELINE_PROMPT_WIKI = """You must answer ONLY with a numbered list of up to 10 PERSON NAMES.
No explanations, no extra sentences, no formatting, no greetings.
If the question cannot be answered, output an empty list (but do NOT add any text).
STRICT RULES:
- Output ONLY the names.
- Each line must start with a number and a dot. Example: "1. Name".
- No additional commentary, no reasoning, no summaries.
- Do NOT repeat the question. Do NOT add anything else.
- Any extra content beyond the list is considered an incorrect answer.
...
BASELINE_PROMPT_WIKI_CATEGORY = """You must answer ONLY with a numbered list of up to 10 entities 
(names, places, locations, objects, movies, organizations, etc.).
No explanations, no extra sentences, no greetings.

STRICT RULES:
- Only output the list of entities relevant to the question.
- Each line must start with a number and a dot. Example: "1. Entity".
- No commentary, no reasoning, no summaries.
- Do NOT repeat the question.
- Do NOT add anything other than the list.
- Any extra text beyond the list is considered an incorrect answer.
