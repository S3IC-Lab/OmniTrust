...
CONFIG_MAPPING_NAMES = {
    'KGW': 'modules.watermark.text_watermark.kgw.KGWConfig',
    'Unigram': 'modules.watermark.text_watermark.unigram.UnigramConfig',
    'SWEET': 'modules.watermark.text_watermark.sweet.SWEETConfig',
    'UPV': 'modules.watermark.text_watermark.upv.UPVConfig',
    'SIR': 'modules.watermark.text_watermark.sir.SIRConfig',
    'XSIR': 'modules.watermark.text_watermark.xsir.XSIRConfig',
    'Unbiased': 'modules.watermark.text_watermark.unbiased.UnbiasedConfig',
    'DIP': 'modules.watermark.text_watermark.dip.DIPConfig',
    'EWD': 'modules.watermark.text_watermark.ewd.EWDConfig',
    'EXP': 'modules.watermark.text_watermark.exp.EXPConfig',
    'EXPGumbel': 'modules.watermark.text_watermark.exp_gumbel.EXPGumbelConfig',
    'EXPEdit': 'modules.watermark.text_watermark.exp_edit.EXPEditConfig',
    'ITSEdit': 'modules.watermark.text_watermark.its_edit.ITSEditConfig',
    'SynthID': 'modules.watermark.text_watermark.synthid.SynthIDConfig',
    'TS': 'modules.watermark.text_watermark.ts.TSConfig',
    'PF':'modules.watermark.text_watermark.pf.PFConfig',
    'MorphMark': 'modules.watermark.text_watermark.morphmark.MorphMarkConfig'
}
...
class AutoConfig:
    ...
    def load(cls, algorithm_name: str, transformers_config: TransformersConfig, algorithm_config_path=None, **kwargs) -> Any:
        ...
        if algorithm_config_path is None:
            algorithm_config_path = f'config/watermark_config/{algorithm_name}.json'
