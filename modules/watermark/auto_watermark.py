...
from modules.watermark.auto_config import AutoConfig

WATERMARK_MAPPING_NAMES={
    'KGW': 'modules.watermark.text_watermark.kgw.KGW',
    'Unigram': 'modules.watermark.text_watermark.unigram.Unigram',
    'SWEET': 'modules.watermark.text_watermark.sweet.SWEET',
    'UPV': 'modules.watermark.text_watermark.upv.UPV',
    'SIR': 'modules.watermark.text_watermark.sir.SIR',
    'XSIR': 'modules.watermark.text_watermark.xsir.XSIR',
    'Unbiased': 'modules.watermark.text_watermark.unbiased.UnbiasedWatermark',
    'DIP': 'modules.watermark.text_watermark.dip.DIP',
    'EWD': 'modules.watermark.text_watermark.ewd.EWD',
    'EXP': 'modules.watermark.text_watermark.exp.EXP',
    'EXPGumbel': 'modules.watermark.text_watermark.exp_gumbel.EXPGumbel',
    'EXPEdit': 'modules.watermark.text_watermark.exp_edit.EXPEdit',
    'ITSEdit': 'modules.watermark.text_watermark.its_edit.ITSEdit',
    'SynthID': 'modules.watermark.text_watermark.synthid.SynthID',
    'TS': 'modules.watermark.text_watermark.ts.TS',
    'PF': 'modules.watermark.text_watermark.pf.PF',
    'MorphMark':'modules.watermark.text_watermark.morphmark.MorphMark'
}
