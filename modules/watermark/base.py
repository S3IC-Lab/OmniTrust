...
class BaseConfig:
    ...
    def __init__(self, algorithm_config_path: str, transformers_config: TransformersConfig, *args, **kwargs) -> None:
        ...
        """
        # Load config file
        self.config_dict = load_config_file(f'config/watermark_config/{self.algorithm_name()}.json') if algorithm_config_path is None else load_config_file(algorithm_config_path)
