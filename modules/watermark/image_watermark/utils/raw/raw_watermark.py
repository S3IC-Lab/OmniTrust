...
from ..raw.tools import wm_method
from ..raw.model_tools import get_model
    
class RAWatermark(object):
    def __init__(self, device = 'cpu', model_type = 'resnet18', save_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'pre_trained'), wm_index = 0):
        ## setup watermark
