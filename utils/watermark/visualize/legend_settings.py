...
class LegendSettings:
    ...
    def __init__(self, legend_font_path: str = font_path, legend_font_size: int = 12, legend_width: int = 160) -> None:
        """
...
class DiscreteLegendSettings(LegendSettings):
    ...
    def __init__(self, legend_font_path: str = font_path, legend_font_size: int = 12, legend_width: int = 160,
                 rec_width: int = 40, text_offset: int = 15, top_spacing: int = 20) -> None:
        """
